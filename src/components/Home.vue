<template>
  <div class="container">
    <x-header :right-options="{showMore: true}" :left-options="{showBack: false}" @on-click-more="login">我的主页</x-header>
    ...
    <tabbar>
      ...
      <tabbar-item show-dot>
        <img slot="icon" src="../assets/community.png">
        <span slot="label">社区</span>
      </tabbar-item>
      <tabbar-item selected link="/component/demo">
        <img slot="icon" src="../assets/serach.png">
